...
BEGIN_MESSAGE_MAP(CSelectView1, CTreeView)
	ON_NOTIFY_REFLECT(TVN_SELCHANGED, &CSelectView1::OnTvnSelchanged)
END_MESSAGE_MAP()
...
void CSelectView1::OnInitialUpdate()
{
...
void CSelectView1::OnTvnSelchanged(NMHDR* pNMHDR, LRESULT* pResult)
{
